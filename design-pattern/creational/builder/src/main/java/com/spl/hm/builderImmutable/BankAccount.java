package com.spl.hm.builderImmutable;
...
public class BankAccount {
    ...
    public static class BankAccountBuilder {
        ...
        public BankAccount build() {
            ...
            BankAccount bankAccount = new BankAccount(this.name, this.accountNumber, this.address, this.email, this.newsletter, this.mobileBanking);
            return bankAccount;
        }
